...
export default function BlogDetailPage() {
  ...
  const handleLike = async () => {
    ...
    try {
      ...
      showToast(res.isLiked ? "Article added to your favorites!" : "Removed from favorites.", "success");
      refetch();
    } catch (err: any) {
    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-grow mx-auto max-w-3xl w-full px-6 py-12">
        ...
        <div className="mb-8 mt-4">
          <div className="flex items-center gap-4 text-[10px] text-muted font-semibold uppercase tracking-wider mb-3">
            ...
            <span className="flex items-center gap-1">
              ...
              By {article.authorName || article.author?.username || "Editorial Staff"}
            </span>
          </div>
        ...
        {/* Post Cover */}
        <div className="h-[350px] rounded-lg overflow-hidden border border-card-border mb-10 relative">
          <img
        ...
        <div className="border-t border-card-border pt-8 mt-12 flex justify-between items-center">
          ...
          >
            ...
            {isLikedByUser ? "Liked" : "Like Article"} ({article.likes?.length || 0})
          </button>
        </div>
        ...
        <div className="mt-16 border-t border-card-border pt-10">
          ...
          <form onSubmit={handleAddComment} className="flex gap-3 mb-8">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded bg-foreground text-background px-4 hover:bg-gold hover:text-luxury-white transition-colors"
            >
          ...
          <div className="flex flex-col gap-6">
            {!article.comments || article.comments.length === 0 ? (
              ...
              article.comments.map((comment: any) => {
                ...
                return (
                  <div key={comment._id} className="bg-card-bg border border-card-border/50 p-4 rounded flex justify-between gap-4">
                    <div>
